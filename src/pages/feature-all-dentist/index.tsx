...
import styles from "./feature-all-dentist.module.scss";
import {
  Table,
  AutoComplete,
  MultiSelect,
...
export const FeatureAllDentist = () => {
  ...
  const fetchData = useCallback(async () => {
    ...
    try {
      const response = await axios.post(
        `${import.meta.env.VITE_BASE_HOST}/dso/all-dentist?page=${
          pagination.page
