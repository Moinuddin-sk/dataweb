...
import styles from "./feature-reverse-lookup.module.scss";
...
import { OwnerShip } from "constants/drop-down-options";
const defaultFilter = {
  dso_name: "",
  ownership: [],
  pe_firm:"",
...
export const FeatureReverseLookUp = () => {
  ...
  const fetchData = useCallback(async () => {
    ...
    try {
      const response = await axios.post(
        `${import.meta.env.VITE_BASE_HOST}/dso/reverse-lookup?page=${
          pagination.page
    ...
    <div className={styles.filter_result_container}>
      <div className={styles.filter_container}>
        {/* <div> */}
          ...
          <AutoComplete
            placeholder="PE Firm"
            value={filter.pe_firm}
            api={`${import.meta.env.VITE_BASE_HOST}/master/get-pefirm-suggestion`}
            onSelect={(data) => {
              onSelect(data, "pe_firm");
            }}
          />
          <LocationSelect
