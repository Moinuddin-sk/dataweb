...
import styles from "./feature-dso-info.module.scss";
    ...
    if (id) {
      try {
        const response = await axios.get(
          `${import.meta.env.VITE_BASE_HOST}/dso/profile?profileId=${id}`
        );
